...
const Accordian = ({ title, incoming, recieved, listed, offers }) => {
            ...
            <div className="border border-primary-text/50 bg-white p-3 rounded-md flex justify-between items-center">
              ...
              {recieved && (
                <div className="space-x-2">
                  <button
                    className="bg-success/500 text-white font-medium text-sm px-3 py-1 rounded-md"
              ...
              {listed && (
                <button className="bg-error/500 text-white font-medium text-sm px-3 py-1 rounded-md">
                  Cancel
                </button>
              )}
            </div>
